...
func (g *fileGenerator) renderAttrs(node *gotemplate.Node) ([]jen.Code, bool) {
	...
	for _, attr := range node.Attrs {
		...
		case gotemplate.AttrEvent:
			g.add(fmt.Sprintf("event attribute %q generation is not supported in the static render slice", attr.RawName), attr.Span)
			ok = false
